...
class AddClient extends Component {
    ...
    onUserIdBlur = (e) => {
        ...
        if (userIds != null && userIds != undefined && userIds.length > 0 && userIds !== "" && userIds !== " ") {
            ...
            for (let i = 0; i < userIds.length; i++) {
                ...
                if (result) {
                    this.growl.show({ severity: 'error', summary: 'Error', detail: 'ClientId already exists on server' });
    ...
    saveUser = () => {
        let user = {UserId: this.state.userId, Password: this.state.password, RoleId: 3}
        this.userSerivce
            .Register(user)
            .then((data) => {
                this.growl.show({ severity: 'success', summary: 'Success', detail: 'Client Created' });
                let userIds = this.state.usersList;
                        ...
                        <div className="p-grid ">
                            ...
                            <div className=" p-col-12 p-sm-12 p-md-6 p-lg-6">
                                <span className="ui-float-label">
                                    <label htmlFor="float-input">ClientId or Email</label>
