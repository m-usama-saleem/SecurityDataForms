    ...
    onDeleteUser() {
        ...
        if(userName != undefined && userName != null){
            this.userSerivce.DeleteUser(userName).then(() => {
                ...
                this.growl.show({ severity: 'success', summary: 'Success', detail: 'Client Deleted Successfully' });
                this.setState({
                    users: [...list],
                    displayDeleteDialog: false,
                    loadingModel: false,
          ...
          <div className="card card-w-title">
            ...
            <div className="content-section implementation">
                <DataTable value={this.state.users} contextMenuSelection={this.state.selectedUser}
                    ...
                    <Column field="userName" header="ClientId or Email" filter={true} filterMatchMode="contains" filterPlaceholder="ClientId or Email" />
              </DataTable>
              ...
              <Dialog visible={this.state.displayDeleteDialog} width="400px" header="You sure to delete this Client?"
              ...
              <Dialog visible={this.state.displayPasswordChangeDialog}  header="Change Client Password" style={{width: '250px'}}
