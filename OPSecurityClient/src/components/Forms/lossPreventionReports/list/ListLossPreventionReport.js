...
import LossPreventionService from '../../../../api/lossPreventionReports/lossPreventionService';
...
class ListLossPreventionReport extends Component {
    ...
    constructor(props) {
        ...
        this.service = new LossPreventionService();
    }
    ...
    getSecurityLogsList() {
        this.service.GetAll(this.props.type).then(data => {
    ...
    Delete = () => {
        var Obj = {
            ...
            LossPreventionType: this.props.type,
                ...
                <div className="p-grid p-fluid" >
                    <div className="card card-w-title">
                        ...
                        <div className="content-section implementation">
                            ...
                            <Dialog visible={this.state.displayDialog} width="300px" header={this.props.title}
                                        ...
                                        <div className="p-grid p-fluid" >
                                            <div className="card card-w-title">
                                                ...
                                                <div className="p-grid ">
                                                    ...
                                                    <div className=" p-col-12 p-sm-12 p-md-12 p-lg-12" style={{display: 'flex'}}>
...
export default withAuthorization(condition)(ListLossPreventionReport);